                ...
                <main class="col-12 max-width-xl">
                    ...
                    <x-element.flex flex="justify-content-center">
                        @foreach ($contents as $content)
                            @auth
                                <div class="m-2">
                                    <x-element.ticket.content.link style="height: 250px; width: 250px;" href="{{ url($content->content->user_id . '/' . ($content->content->path ? $content->content->path . '/' : '') . $content->content->title) }}" image="/storage/contents/{{ $content->content->user_id }}/{{ ($content->content->path ? $content->content->path . '/' : '') . $content->content->name }}" title="{{ $content->content->title }}">
