...
7. Реализовать добавление контента;
8. Реализовать вывод контента на странице "мой контент";
9. Реализовать удаление контента;
10. Реализовать вывод контента на главной;
