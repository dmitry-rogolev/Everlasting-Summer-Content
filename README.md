...
8. Реализовать добавление контента;
9. Реализовать вывод контента на странице "мой контент";
10. Реализовать удаление контента;
11. Реализовать вывод контента на главной;
