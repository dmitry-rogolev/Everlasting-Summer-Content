...
22. Реализовать добавление контента с помощью Drag and Drop;
23. Реализовать добавление каталогов с контентом;
24. Реализовать поиск контента;
25. Реализовать отображение информации о пользователе на странице профиля;
26. Добавить информацию о контенте на странице контента;
27. Реализовать добавление контента в понравившиеся;
