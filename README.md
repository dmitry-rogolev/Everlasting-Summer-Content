...
23. Реализовать отображение информации о пользователе на странице профиля;
24. Добавить информацию о контенте на странице контента;
25. Реализовать добавление контента в понравившиеся;
26. Реализовать добавление контента в избранное;
27. Реализовать добавление комментариев к контенту;
28. Реализовать добавление комментариев в понравившиеся;
29. Реализовать сортировку контента;
30. Протестировать приложение;
31. Задокументировать приложение;
32. Выпустить версию 1.0.0
